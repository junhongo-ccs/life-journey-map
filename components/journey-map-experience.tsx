...
const STOPS: Stop[] = [
  ...
  },
  {
    ...
    zoom: 17,
    bearing: 202,
    episode: "一人暮らし、フリーランスを始めた街で、フジテレビや教育テレビ、テレ東などテレビのCGコンテンツ制作をしていました。",
  },
  {
    id: "kyodo",
    label: "世田谷区　経堂",
  ...
  },
  {
    id: "nishikoyama",
    label: "品川区　西小山",
    coordinates: [139.7001160142415, 35.61742948380115],
    zoom: 17,
    bearing: 246,
  ...
  },
  {
    id: "ogikubo",
    label: "杉並区　荻窪",
    coordinates: [139.6208148342435, 35.7017498907415],
    zoom: 17,
    bearing: 18,
